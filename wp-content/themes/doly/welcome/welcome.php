...
if (!class_exists('DOLY_WELCOME')) :
    ...
    class DOLY_WELCOME {
        ...
        public function admin_notice() {
            $hide_notice = get_option('doly_hide_notice5');
            if (!$hide_notice) {
        ...
        public function admin_notice_content() {
            ...
            <div class="updated notice doly-welcome-notice">
                <div class="doly-welcome-notice-wrap">
                    ...
                    <a href="<?php echo wp_nonce_url(add_query_arg('doly_hide_notice5', 1), 'doly_hide_notice5_nonce', 'doly_notice_panel'); ?>" class="notice-close"><?php esc_html_e('Dismiss', 'doly'); ?></a>
                </div>
        ...
        public function hide_admin_notice() {
            if (isset($_GET['doly_hide_notice5']) && isset($_GET['doly_notice_panel']) && current_user_can('manage_options')) {
                if (!wp_verify_nonce(wp_unslash($_GET['doly_notice_panel']), 'doly_hide_notice5_nonce')) {
                    wp_die(esc_html__('Action Failed. Something is Wrong.', 'doly'));
                }

                update_option('doly_hide_notice5', true);
            }
        }
        ...
        public function erase_hide_notice() {
            delete_option('doly_hide_notice5');
        }
    }
